...
export const INITIAL_PHRASES: Phrase[] = [
  ...
  // Intermediário
  { id: 'p21', type: 'sentence', moduleId: 'm1', level: 'Intermediário', portuguese: 'Vamos agilizar o processo.', english: "Let's streamline the process.", order: 1 },
  { id: 'p22', type: 'sentence', moduleId: 'm1', level: 'Intermediário', portuguese: 'Fomente uma cultura de inovação.', english: 'Foster a culture of innovation.', order: 2 },
  { id: 'p23', type: 'sentence', moduleId: 'm1', level: 'Intermediário', portuguese: 'Mitigue riscos potenciais de forma proativa.', english: 'Proactively mitigate potential risks.', order: 3 },
  { id: 'p24', type: 'sentence', moduleId: 'm1', level: 'Intermediário', portuguese: 'Capacite os membros da sua equipe.', english: 'Empower your team members.', order: 4 },
  { id: 'p25', type: 'sentence', moduleId: 'm1', level: 'Intermediário', portuguese: 'Promova a colaboração multifuncional.', english: 'Promote cross-functional collaboration.', order: 5 },
  { id: 'p26', type: 'sentence', moduleId: 'm1', level: 'Intermediário', portuguese: 'Otimize a alocação de recursos.', english: 'Optimize resource allocation.', order: 6 },
  { id: 'p27', type: 'sentence', moduleId: 'm1', level: 'Intermediário', portuguese: 'Mantenha uma vantagem competitiva.', english: 'Maintain a competitive advantage.', order: 7 },
  { id: 'p28', type: 'sentence', moduleId: 'm1', level: 'Intermediário', portuguese: 'Aproveite nossos pontos fortes.', english: 'Leverage our strengths.', order: 8 },
  { id: 'p29', type: 'sentence', moduleId: 'm1', level: 'Intermediário', portuguese: 'Garanta a conformidade com as regulamentações.', english: 'Ensure compliance with regulations.', order: 9 },
  { id: 'p30', type: 'sentence', moduleId: 'm1', level: 'Intermediário', portuguese: 'Cultive relacionamentos fortes com os clientes.', english: 'Strong client relationships.', order: 10 },

  // Avançado
  { id: 'p31', type: 'sentence', moduleId: 'm1', level: 'Avançado', portuguese: 'Articule uma visão estratégica convincente.', english: 'Articulate a compelling strategic vision.', order: 1 },
  { id: 'p32', type: 'sentence', moduleId: 'm1', level: 'Avançado', portuguese: 'Incentive o pensamento disruptivo.', english: 'Encourage disruptive thinking.', order: 2 },
  { id: 'p33', type: 'sentence', moduleId: 'm1', level: 'Avançado', portuguese: 'Navegue por dinâmicas organizacionais complexas.', english: 'Navigate complex organizational dynamics.', order: 3 },
  { id: 'p34', type: 'sentence', moduleId: 'm1', level: 'Avançado', portuguese: 'Promova um ambiente de segurança psicológica.', english: 'Foster an environment of psychological safety.', order: 4 },
  { id: 'p35', type: 'sentence', moduleId: 'm1', level: 'Avançado', portuguese: 'Impulsione o crescimento sustentável a longo prazo.', english: 'Drive sustainable long-term growth.', order: 5 },
  { id: 'p36', type: 'sentence', moduleId: 'm1', level: 'Avançado', portuguese: 'Inculque um senso de propósito e pertencimento.', english: 'Instill a sense of purpose and belonging.', order: 6 },
  { id: 'p37', type: 'sentence', moduleId: 'm1', level: 'Avançado', portuguese: 'Orquestre mudanças transformacionais em toda a empresa.', english: 'Orchestrate company-wide transformational change.', order: 7 },
  { id: 'p38', type: 'sentence', moduleId: 'm1', level: 'Avançado', portuguese: 'Aproveite a inteligência coletiva da força de trabalho.', english: 'Harness the collective intelligence of the workforce.', order: 8 },
  { id: 'p39', type: 'sentence', moduleId: 'm1', level: 'Avançado', portuguese: 'Demonstre agilidade em face da incerteza.', english: 'Demonstrate agility in the face of uncertainty.', order: 9 },
  { id: 'p40', type: 'sentence', moduleId: 'm1', level: 'Avançado', portuguese: 'Incorpore princípios de liderança servidora.', english: 'Embody servant leadership principles.', order: 10 },
